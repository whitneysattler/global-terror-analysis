...
sapply(gtdCleanedRemoved, class)
gtdCleanedRemoved$iday = factor(gtdCleanedRemoved$iday, levels = (1:31), ordered = TRUE)
factorize = c("crit1", "crit2", "crit3", "country", "region", "vicinity", "alternative", "multiple", "targttype1", "guncertain1", "hostkidoutcome", "INT_LOG", "INT_IDEO", "INT_MISC", "attack2", "attack5", "attack6", "attack7", "weaponType5", "weaponType6", "weaponType8", "weaponType9", "weaponType13", "season", "natltyregion")
